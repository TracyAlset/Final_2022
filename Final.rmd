...
The odd ratio is `r malefisher$estimate`, and this tells us that the odds for the males taking the placebo to have covid is 2.1 to 1 to those who take the vaccine,meaning there are 2.1 males that took the placebo and tested positive for covid for every 1 male that took the vaccine and had covid. and this proves the effictiveness of the vaccine for males.
...
In this project we tried to find the efficiency of a certain vaccine in four different cases
